...
function ServiceCard({ item }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-md bg-white px-3 py-4 text-center shadow-sm border border-gray-50">
      {item.icon ? (
          ...
          <div className="flex flex-col gap-8">
            <div className="relative overflow-hidden rounded-2xl shadow-xl">
              ...
              <div className="absolute left-5 right-5 top-5 flex items-start justify-between z-[2]">
                <h1 className="font-figtree text-xl italic font-black text-white drop-shadow-md">{store.name}</h1>
    ...
    <section className="w-full bg-[#FEF5F1] py-14">
      <div className="container-main max-w-360">
        <div className="grid grid-cols-1 xl:gap-10 lg:gap-8 lg:grid-cols-[minmax(0,45fr)_minmax(0,55fr)]">
          ...
          <div className="relative overflow-hidden rounded-sm group">
            <div className="relative aspect-[4/4.3] w-full h-full">
              ...
              {displayImages.length > 1 && (
                <>
                  <button className="store-banner-prev absolute left-4 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-white/20 backdrop-blur-md text-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                    <ChevronLeft size={24} />
                  </button>
                  <button className="store-banner-next absolute right-4 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-white/20 backdrop-blur-md text-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          {/* RIGHT: Store Details (Exact same as locator) */}
          <div className="min-w-0 flex flex-col justify-center">
            ...
            <div className="mt-4">
              <Button asChild className="h-14 w-full text-white font-bold text-base uppercase tracking-wider shadow-lg bg-primary hover:opacity-90">
