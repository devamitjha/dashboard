        ...
        {storeBlocks.length > 0 && (
          <div className="address-locations-footer mb-20 border-b border-zinc-50 pb-20">
            <div className="max-w-xl mb-12">
              <h3 className="text-lg md:text-3xl font-medium text-zinc-900 mb-4 uppercase tracking-tight font-abhaya">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              {storeBlocks.map((block, idx) => (
                <div key={idx} className="store-location-item space-y-6">
                  <h4 className="text-base md:text-xl font-bold text-zinc-900 uppercase tracking-widest font-abhaya">
                    {block.settings.store_name}
                  </h4>
                  <ul className="space-y-4">
                    <li className="flex items-center gap-4 text-sm md:text-lg text-zinc-500 font-figtree">
            ...
            if (block.type === 'heading') {
              ...
              return (
                <Tag
                  ...
                  className={`text-${block.settings.alignment || 'left'} text-lg md:text-3xl mt-0 mb-8`}
                >
